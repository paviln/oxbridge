...
router.put('/startEvent/:eventId', eventController.startEvent);

// Updating event property "isLive" to false
router.get('/stopEvent/:eventId', eventController.stopEvent);
...
router.get('/myEvents/findFromUsername', eventController.findFromUsername);
